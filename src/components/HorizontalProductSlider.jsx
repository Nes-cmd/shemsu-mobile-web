const HorizontalProductSlider = () => {
    return (
        ...
        <div className="product-header">
            ...
            <span style={{color: "rgb(227, 185, 46)"}}>
        ...
        <div className="products">
            <a href="single-product.html" className="product-card">
                ...
                <div className="card-desc">
                    <p>Chinese wireless headphone</p>
            ...
            <a href="single-product.html" className="product-card">
                <div className="card-image">
                    <span className="deal">545 OFF</span>
                    <img src="storage/app/public/product/thumbnail/2022-11-01-63618d9a35a0e.png" alt="" />
                </div>
                <div className="card-desc">
                    <p>Gaming keyboard and mouse</p>
                    <div className="rating">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                stroke="currentColor" className="w-6 h-6">
                    ...
                    <span className="discount">35 Birr</span>
                    <span className="price">566.00 Birr</span>
                </div>
            </a>
            <a href="single-product.html" className="product-card">
                <div className="card-image">
                ...
                <div className="card-desc">
                    <p>Tablet, watch, phone and Earphode in one</p>
                    <div className="rating">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                                stroke="currentColor" className="w-6 h-6">
            ...
            <a href="single-product.html" className="product-card">
                ...
                <div className="card-desc">
                    ...
                    <span className="discount">45 Birr</span>
                    <span className="price">456.00 Birr</span>
                </div>
            </a>
        </div>
    </section>
